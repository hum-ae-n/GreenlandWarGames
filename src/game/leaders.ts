...
export const LEADERS: Record<LeaderId, LeaderPersonality> = {
  ...
  carney: {
    ...
    traits: ['calculating', 'diplomatic', 'cautious'],
    greetings: [
      "Canada's Arctic assets represent significant strategic value.",
      "The Northwest Passage is Canadian sovereign territory. Full stop.",
      "We're taking a measured approach to Arctic development.",
    ],
    threats: [
      "Canada has the economic tools to respond appropriately.",
      "This threatens Canadian interests. We will act decisively.",
      "Don't underestimate Canada's resolve on sovereignty.",
    ],
    negotiations: [
      "Let's discuss the economics of cooperation.",
      "Canada is open to mutually beneficial arrangements.",
      "A sensible framework benefits all Arctic stakeholders.",
    ],
    victories: [
      "A sound investment in Canada's future.",
      "Canadian Arctic strategy delivers results.",
      "This strengthens our position considerably.",
    ],
    defeats: [
      "We'll reassess and adapt our approach.",
      "Canada's long-term interests remain unchanged.",
      "A setback, but our fundamentals are strong.",
    ],
    reactions: {
      military_buildup: ["Escalation carries significant economic costs."],
      treaty_offer: ["We'll evaluate this proposal carefully."],
      territorial_claim: ["The Northwest Passage is not negotiable."],
      economic_pressure: ["Canada's economy is resilient."],
    },
  },
