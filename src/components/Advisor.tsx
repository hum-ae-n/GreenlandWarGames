...
const FACTION_ADVISORS: Record<FactionId, { leader: LeaderId; title: string; style: string }> = {
  ...
  canada: { leader: 'carney', title: 'Arctic Council Rep', style: 'cooperative' },
...
const generateDiplomaticMessages = (gameState: GameState): DiplomacyMessage[] => {
  ...
  const messageTemplates: Record<string, Record<string, string[]>> = {
    ...
    carney: {
      cooperation: ["A sensible approach. Canada values stability.", "Cooperation yields the best returns for all."],
      competition: ["The Northwest Passage is Canadian. That's non-negotiable.", "Let's discuss this rationally."],
      confrontation: ["This isn't a sustainable position for either of us.", "Reconsider - the costs outweigh the benefits."],
      crisis: ["Canada will protect its interests. Don't test our resolve.", "You're forcing an economic response."],
      conflict: ["Canada didn't seek this, but we'll defend our sovereignty.", "The Arctic is our home. We know it well."],
    },
  };
